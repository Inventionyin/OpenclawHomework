...
const PROACTIVE_TYPE_MAP = {
  proactive: ['token-factory', 'trend-token-factory', 'ui-automation', 'daily-digest', 'news-digest', 'token-lab', 'hot-monitor', 'research-dev-loop', 'skill-flow', 'web-content-fetch'],
  news: ['news-digest'],
  hot: ['hot-monitor'],
  ui: ['ui-automation'],
