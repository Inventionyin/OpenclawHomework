...
STREAMING_MODEL_API_KEYS=__FILL_LONGCAT_API_KEY__,__FILL_LONGCAT_BACKUP_API_KEY__
...
# Optional OpenAI-compatible gateway fallback. Effective only when STREAMING_MODEL_* is not set.
MODEL_GATEWAY_BASE_URL=
MODEL_GATEWAY_API_KEYS=
MODEL_GATEWAY_MODEL=
MODEL_GATEWAY_SIMPLE_MODEL=
MODEL_GATEWAY_THINKING_MODEL=
LITELLM_BASE_URL=
LITELLM_API_KEYS=
LITELLM_MODEL=
LITELLM_SIMPLE_MODEL=
LITELLM_THINKING_MODEL=
